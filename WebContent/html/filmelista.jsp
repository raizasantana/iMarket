...
<title>iMarket - Listar Filmes</title>
</head>
<body>
...
<c:forEach var="fil" items="${filmes}">
 <tr>
 <td rowspan="2"><a href="/ProjetoFinal/Servlet?classe=SessaoControl&acao=listar&idfilme=${fil.id}&destino=/html/verfilme.jsp"><img src="/ProjetoFinal/img/${fil.id}.jpg" width="150" height="180"></a> </td>
 <td height="20" valign="top"><a class="nome-filme" href="/ProjetoFinal/Servlet?classe=SessaoControl&acao=listar&idfilme=${fil.id}&destino=/html/verfilme.jsp">${fil.nome}</a></td>
 </tr>   
<tr height="80">
 	<td  valign="top">${fil.sinopse} <br><br>
 	Exibi&ccedil;&atilde;o:  ${fil.dataIni} - ${fil.dataFin}
 	</td> 
  </tr>
<tr height="18" >
