...
<table border="0" >
 ...
 <td>    
<c:if test="${cadeiras.status==1}">
 
 <center> 
     <p align="center"><a href="/ProjetoFinal/index.jsp">${cadeiras.nome}${cadeiras.numero} <br><img src="/ProjetoFinal/img/cadeiralivre.png" border="0"> </a></p>
 </center>
...
<center> 
     <p align="center"><a href="/ProjetoFinal/index02.html">${cadeiras.nome}${cadeiras.numero} <br><img src="/ProjetoFinal/img/cadeiraocupada.png" border="0"> </a></p>
</center>
 </div>
</c:if>
</td>
