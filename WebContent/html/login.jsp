...
<fieldset id="cadastro"><legend class="nome-filme">Efetue
Login</legend>
<form action="/ProjetoFinal/Servlet" method="get"><input
	type="hidden" name="acao" value="logar"> <input type="hidden"
	name="classe" value="ClienteControl">
<p>LOGIN <input type="text" name="login" maxlength="10"></p>
<p>SENHA <input type="password" name="senha" maxlength="10"></p>
<input type="hidden" name="destino" value="index02.html"> <input
	class="botao" type="submit" value="Enviar" />
<p><a class="link-pagina" href="/ProjetoFinal/html/frmcliente.html">[CADASTRE-SE] </a></p>

<c:if test="${cliente.nome!=null}">
	<p>Cliente Logado:${cliente.nome}
	<p>
	<p><a class=link-pagina
		href="/ProjetoFinal/Servlet?classe=ClienteControl&acao=sair&destino=index02.html">
	[LOGOUT] </a></p>
</c:if> <c:if test="${funcionario.nome!=null}">
	<p>Funcionario Logado:{funcionario.nome}
	<p>
	<p><a class=link-pagina
		href="/ProjetoFinal/Servlet?classe=FuncionarioControl&acao=sair&destino=index02.html">
	[LOGOUT] </a></p>
</c:if></form>
</fieldset>
<br>
