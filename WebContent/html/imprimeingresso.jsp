...
<div id="ingresso">
	...
	<tr>
	<td colspan="2">
	Filme: ${ingresso.sessao.filme.nome}<br>
	<hr size="1" width="100%" color="#191970">	
	Sala: ${ingresso.sessao.sala.nome}<br>
	<hr size="1" width="100%" color="#191970">
	Tipo: ${ingresso.tipo.descricao}<br>
	<hr size="1" width="100%" color="#191970">
	Cadeira: ${ingresso.cadeira.nome}${ingresso.cadeira.numero}<br>
	<hr size="1" width="100%" color="#191970">
	Horario: ${ingresso.sessao.horaIni}<br>
	<hr size="1" width="100%" color="#191970">
	Data: ${ingresso.sessao.data}<br>	
	</td>
	</tr>	
	...
	<a  class="link-pagina" href="#">          [ IMPRIMIR ]</a>
