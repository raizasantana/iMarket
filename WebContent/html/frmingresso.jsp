...
<c:if test="${cadeiras.status==1}">
 ...
 <center> 
   <a href="/ProjetoFinal/Servlet?acao=lancarcadeira&classe=IngressoControl&idcadeira=${cadeiras.id}&destino=/html/finalizaringresso.jsp">${cadeiras.nome}${cadeiras.numero}<br><img src="/ProjetoFinal/img/cadeiralivre.png" > </a>
 </center>
...
<center> 
     <p align="center">${cadeiras.nome}${cadeiras.numero} <br><img src="/ProjetoFinal/img/cadeiraocupada.png"> </p>
</center>
